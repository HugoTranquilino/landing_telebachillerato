...
function Home() {
    ...
    var email = "30ETH0027C@mediasuperior.msev.gob.mx"
    var phone = "78523065"
    return (
        <div className="App">
            ...
            <Row>
                ...
                <Col sm={6}>
                    <div className='item'>
                        ...
                        <p><span className="item-b">Teléfono: </span>{phone}</p>
                        <p><span className="item-b">Correo electrónico: </span>{email.toLowerCase()} </p> 
